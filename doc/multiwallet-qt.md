...
In order to support loading of multiple wallets in ulord-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ulord.cpp.
...
Changes to ulord.cpp
----------------------
ulord.cpp is the entry point into ulord-qt, and as such, will require some minor modifications to provide hooks for
