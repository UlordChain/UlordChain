...
class TxnMallTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # 400 UT serialized is 00902f5009000000
        pos0 = 2*(4+1+36+1+4+1)
        ...
        # Node0's balance should be starting balance, plus 500UT for another
        ...
        # Check node0's total balance; should be same as before the clone, + 1000 UT for 2 matured,
