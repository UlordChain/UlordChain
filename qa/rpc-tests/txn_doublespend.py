...
class TxnMallTest(BitcoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 12,500 UT:
        ...
        # First: use raw transaction API to send 12400 UT to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 500 UT coin each
        ...
        # Node0's total balance should be starting balance, plus 1000UT for
