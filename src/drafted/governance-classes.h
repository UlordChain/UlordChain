 ...
 *
 *   // network
 *   CUlordNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.ulord.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CUlordNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: UlordNetwork
// //   -- signature requirements : Key1(User)
// class CUlordNetworkVariable : public CGovernanceObject
// {
// private:
